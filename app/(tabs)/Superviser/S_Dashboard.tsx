...
const S_Dashboard = ({navigateTo}) => {
  ...
  useEffect(() => {
    const fetchShiftDetails = async () => {
      try {
        if (user) {
          const res = await axios.get('http://localhost:3000/iwantworkers', { params: { userId: user._id } });
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.header} onPress={()=>navigateTo('login')}>Supervisor Dashboard</Text>
        <Image
...
//             if (user) {
//                // const res = await axios.get('http://localhost:3000/iwantworkers', { params: { userId: user._id } });
//                const res = await axios.get('http://localhost:3000/api/iwantworkers', { params: { userId: user._id } });
...
//             }
//         } catch (err) {
//             console.error('Error fetching shift details:', err.response ? err.response.data : err.message);
//         }
//     };
...
//       {/* Display Supervisor and Workers */}
//       {employees.length > 0 ? (
//         filteredEmployees.map((employee) => (
//           <View key={employee.emp_id} style={styles.employee}>
//             <View style={styles.employeeInfo}>
//               <Image
//                 source={{ uri: 'https://th.bing.com/th/id/OIP.AxJFy3lGG645DOcVKBVeyAHaJh?w=167&h=215&c=7&r=0&o=5&dpr=1.3&pid=1.7' }}
//                 style={styles.iconRight}
...
//                 <Text>Work Type: {employee.work_type}</Text>
//               </View>
//             </View>
//             <TouchableOpacity style={styles.viewButton} onPress={() => navigateTo('s_viewshift')}>
//               <Text style={styles.viewText}>View detail</Text>
...
//           <Text style={styles.buttonText}>Add Shift</Text>
//         </TouchableOpacity>
//         <TouchableOpacity style={styles.footerButton} onPress={() => navigateTo('danger')}>
//           <Image
//             source={{ uri: 'https://example.com/alert-icon.png' }}
//             style={styles.icon}
//           />
