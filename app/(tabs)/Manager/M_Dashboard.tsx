  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text onPress={()=>navigateTo('addshift_m')}>Add User</Text>
        <TouchableOpacity style={styles.dateButton}>
        
          <Text style={styles.dateText} onPress={()=>navigateTo('add_user_m')}>Jan 01 - Jan 08</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.attendanceContainer}>
        ...
        <View style={styles.statisticsContainer}>
          ...
          <View style={styles.progressCircleContainer}>
            {/* Placeholder for ProgressCircle or other components */}
      ...
      <View style={styles.workloadContainer}>
        ...
        <Image
          source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSw1pxgevHnZRm4j-wV4t8Zq1gvDPWJbaIuiA&s' }} // Replace with actual image URI
      ...
      <TouchableOpacity>
        ...
        <TouchableOpacity onPress={()=>navigateTo('smp')}>
          ...
          <Text style={styles.footertext}>SMP</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>navigateTo('m_alerts')}>
        ...
        <TouchableOpacity onPress={()=>navigateTo('erp')} style={styles.footertext}>
          ...
          <Text onPress={()=>navigateTo('erp')} style={styles.footertext}>ERP</Text>
        </TouchableOpacity>
        <TouchableOpacity>
